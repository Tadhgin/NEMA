...
AURELIUS_URL = 'http://localhost:5002/generate'
...
def conversation_loop(initial_prompt, turns=10):
    ...
    for i in range(turns):
        ...
        # Allow Tag to speak before Aurelius replies
        ...
        caelum_reply = query(AURELIUS_URL, prompt)
        print(f"🛡️ Aurelius: {aurelius_reply}")
...
if __name__ == '__main__':
    print("Welcome to the Echo ↔ Aurelius loop. You are Tag. Interject at any time.")
